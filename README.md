...
2. Run the `active-inactive.py` script locally using the INFLUX_USERNAME and INFLUX_PASSWORD credentials for that server (see CHORDS_ADMIN_PW). Configured for CLI execution: `python3 active-inactive.py <path/to/download/files> <chords portal name>`
